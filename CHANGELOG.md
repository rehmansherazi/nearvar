...
All changes to NearVar are documented here.
...
## [0.2.4] — fix: multi-root workspace support — scan all workspace folders for nearvar.yaml — 2026-06-27

Initial multi-root workspace fix: NearVar now scans all `workspaceFolders` entries for `nearvar.yaml` rather than reading only `workspaceFolders[0]`.

---

## [0.2.3] — chore: update nearvar.yaml template — better runbook examples, demoscripts hint — 2026-06-27

Updated the `nearvar.yaml` template generated by "Create nearvar.yaml" to include more realistic folder examples and a comment block pointing to the demoscripts in the NearVar repo.

---

## [0.2.2] — fix: bundle js-yaml with esbuild — fix runtime module-not-found error — 2026-06-27

`js-yaml` was listed as a dependency but was not bundled into the extension output, causing a runtime "Cannot find module 'js-yaml'" error when parsing `nearvar.yaml`. Fixed by updating `esbuild.js` to bundle all dependencies into the output files.

---

## [0.2.1] — chore: version bump and housekeeping — 2026-06-27

Internal version bump. No user-visible changes.

---

## [0.2.0] — feat: search/filter and collapsible sections — 2026-06-21
...
## [0.0.1] — Panel scaffold — 2026-06-17
...
## [0.0.1] — Project scaffold — 2026-06-17

Files created: package.json, tsconfig.json, src/extension.ts, src/panel.ts, src/bashReader.ts, src/configReader.ts, .vscodeignore, README.md, CHANGELOG.md, ROADMAP.md
