...
| SEP-01 | Panel scaffold | ⬜ planned | Webview opens, CSP + escapeHtml from day one, context bar, welcome card |
| SEP-02 | Static items + paste | ⬜ planned | Hardcoded items, click-to-paste (insert without execute), all platforms |
