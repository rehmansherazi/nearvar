...
**Status:** All v1 SEPs complete and smoke tested. Publish prep done. Problems-tab issues fixed (SVG→PNG icon, redundant onView activation event removed). PNG icon generated and wired in. .gitignore created. Pending: create GitHub repo, push main, then vsce publish.
...
a8daf56 — Fix: PNG icon for Marketplace, remove redundant activation event
...
- [x] `images/icon.svg` — 128×128 viewBox, sidebar activitybar icon
